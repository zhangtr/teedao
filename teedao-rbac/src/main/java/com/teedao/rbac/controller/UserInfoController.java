...
public class UserInfoController {
    ...
    public HttpEntity userInfo(HttpServletRequest request) throws OAuthSystemException {
        try {
            ...
            //返回用户信息
            OAuthCacheElement element = oAuthService.getElementByAccessToken(accessToken);
            OAuthUserInfo userInfo=userService.findOAuthUserInfo(element);
